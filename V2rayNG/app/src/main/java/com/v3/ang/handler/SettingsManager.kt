...
import com.v3.ang.AppConfig.ANG_PACKAGE
import com.v3.ang.AppConfig.DEFAULT_SUBSCRIPTION_ID
import com.v3.ang.AppConfig.GEOIP_PRIVATE
import com.v3.ang.AppConfig.GEOSITE_PRIVATE
import com.v3.ang.AppConfig.TAG_DIRECT
import com.v3.ang.AppConfig.VPN
import com.v3.ang.dto.ProfileItem
import com.v3.ang.dto.RulesetItem
import com.v3.ang.dto.SubscriptionItem
import com.v3.ang.dto.V2rayConfig
import com.v3.ang.enums.EConfigType
import com.v3.ang.enums.Language
import com.v3.ang.enums.RoutingType
import com.v3.ang.enums.VpnInterfaceAddressConfig
import com.v3.ang.handler.MmkvManager.decodeAllServerList
import com.v3.ang.handler.MmkvManager.decodeServerConfig
import com.v3.ang.handler.MmkvManager.decodeSubsList
import com.v3.ang.handler.MmkvManager.decodeSubscription
import com.v3.ang.handler.MmkvManager.encodeSubscription
import com.v3.ang.handler.MmkvManager.removeSubscription
...
object SettingsManager {
    ...
    fun routingRulesetsBypassLan(): Boolean {
        ...
        if (config.configType == EConfigType.CUSTOM) {
            ...
            val v3Config = JsonUtil.fromJson(raw, V2rayConfig::class.java)
            val exist = v3Config?.routing?.rules?.filter { it.outboundTag == TAG_DIRECT }?.any {
