...
import com.v3.ang.AppConfig.LOOPBACK
import com.v3.ang.BuildConfig
import com.v3.ang.contracts.ServiceControl
import com.v3.ang.contracts.Tun2SocksControl
import com.v3.ang.handler.MmkvManager
import com.v3.ang.handler.NotificationManager
import com.v3.ang.handler.SettingsManager
import com.v3.ang.handler.V2RayServiceManager
import com.v3.ang.util.MyContextWrapper
...
//        saveVpnNetworkInfo(configName, info)
        ...
        if (isForced) {
            //stopSelf has to be called ahead of mInterface.close(). otherwise v3 core cannot be stooped
            //It's strage but true.
            //This can be verified by putting stopself() behind and call stopLoop and startLoop
            //in a row for several times. You will find that later created v3 core report port in use
            //which means the first v3 core somehow failed to stop and release the port.
            stopSelf()
